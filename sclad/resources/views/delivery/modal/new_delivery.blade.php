                    ...
                    <div id="materials">
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input for="date" type="date"  class="form-control" id="datepicker"  autofocus name="date" value="">
                            ...
                            <table class="table table-bordered" id="materialTable">
                                ...
                                <tr id="material1">
                                    ...
                                    <td>
                                        <input class="form-control form-control-sm" name="material[1][amount]" type="number">
