                ...
                <div class="row ">
                    ...
                    <div class="col col-lg-2">
                        <a href="javascript:void(0)" id="sending_dryer"
                           data-url="{{route('raw_material.create')}}" class="btn btn-outline-success">Отправить в
                            сушилку</a>
                    </div>
                </div>
            @endcan
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="javascript:void(0)" id="edit_amount_material"
                                   data-url="{{route('raw_material.edit',$raw->id)}}" class="btn btn-warning  btn-sm">Изменить
                                    количество</a>
                            </div>
                        </td>
                    @endcan
