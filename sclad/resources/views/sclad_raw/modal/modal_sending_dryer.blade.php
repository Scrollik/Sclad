...
<div class="modal fade" id="sendingdryerModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('raw_material.store')}}" method="POST" id="new_send" >
                @csrf
                <div class="modal-body">
                    <div id="materials">
                        <div class="mb-1">
                            <div class="form-group">
                                ...
                                <input for="date" type="date"  class="form-control" id="datepicker_send"  autofocus name="date" value="">
                                ...
                                <select name="id_dryers" id="select_dryers" class="form-control mt-1">
                                    @foreach($dryers as $dryer)
                                        <option value="{{$dryer->id}}">{{$dryer->dryers_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <table class="table table-bordered" id="materialTable">
                                ...
                                <tr id="material1">
                                    <td> <select name="raw_materials[1][material_id]" id="select_raw_material1" class="form-control">
                                        </select>
                                        <span class="text-danger error-text raw_materials.1.material_id_error"></span>
                                    </td>
                                    <td>
                                        <input class="form-control form-control-sm active" name="raw_materials[1][amount]"  type="number">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="javascript:void(0)" id="add_mat" data-url="{{route('raw_material.create')}}" class="btn btn-warning  btn-sm">Добавить материал</a>
                    </div>
