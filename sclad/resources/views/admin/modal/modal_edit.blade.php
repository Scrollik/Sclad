<div class="modal fade" id="empModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('admin_panel.update',$user)}}" method="POST" id="edit_users">
                @csrf
                @isset($user)
                    @method('PUT')
                @endisset
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control " id="name"  placeholder="Иван" autofocus name="name_sotr" value="">
                            <span class="text-danger error-text name_error"></span>
                        </div>
                        <div class="form-group">
                            <p>Выберите роль сотрудника:</p>
                            <select id="editRole" name="role_rab" class="form-select" aria-label="Default select example">
