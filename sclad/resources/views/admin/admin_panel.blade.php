    ...
    <div class="col-md-12">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a href="javascript:void(0)" data-url="{{route('admin_panel.edit',$user->id)}}" class="btn btn-warning  btn-sm show-user">Редактировать</a>
                            <a href="javascript:void(0)" id="delete_user" data-url="{{route ('admin_panel.destroy',$user)}}" class="btn btn-danger  btn-sm  mx-1">Удалить</a>
                        </div>
                    </td>
                </tr>
            @empty
        ...
        <table class="table  table-bordered">
            ...
            @forelse($materials as $material)
                <tr>
                    <td>{{ $material->id }}</td>
                    <td>{{ $material->name_materials }} {{$material->height}}x{{$material->width}}</td>
                    <td>
                        <div class="btn-group" role="group">
                            <a href="javascript:void(0)" id="show-materials" data-url="{{route('materials.edit',$material->id)}}" class="btn btn-warning  btn-sm">Редактировать</a>
                            <a href="javascript:void(0)" id="delete_materials" data-url="{{route ('materials.destroy',$material)}}" class="btn btn-danger  btn-sm mx-1">Удалить</a>
                        </div>
                    </td>
                </tr>
            @empty
            ...
            <button type="button" class="btn btn-warning mt-1" data-bs-toggle="modal" data-bs-target="#add_new_material">
        ...
        <table class="table  table-bordered">
            ...
            @forelse($dryers as $dryer)
                <tr>
                    <td>{{ $dryer->dryers_name }} </td>
                    <td>
                        <div class="btn-group" role="group">
                            <a href="javascript:void(0)" id="show-dryers" data-url="{{route('dryers.edit',$dryer->id)}}" class="btn btn-warning  btn-sm">Редактировать</a>
                            <a href="javascript:void(0)" id="delete_dryers" data-url="{{route ('dryers.destroy',$dryer)}}" class="btn btn-danger  btn-sm mx-1">Удалить</a>
                        </div>
                    </td>
                </tr>
            @empty
